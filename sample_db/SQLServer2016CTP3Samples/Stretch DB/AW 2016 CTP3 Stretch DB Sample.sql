-------------------------------------------------------------------------------
-- AdventureWorks2016CTP3 samples: Stretch DB
-------------------------------------------------------------------------------
/*
   This demo explores how to use Stretch Database with the following tables and 
   stored procedures in the AdventureWorks2016CTP3 sample database.
...
-------------------------------------------------------------------------------
-- Before stretching the Sales.OrderTracking table in the AdventureWorks2016CTP3 database
