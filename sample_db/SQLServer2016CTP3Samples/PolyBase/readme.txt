...
1. install PolyBase on your SQL Server 2016 CTP3 instance by running setup.exe and selecting PolyBase on the Feature Selection page.
2. restore the AdventureWorksDW2016CTP3 backup to a SQL Server 2016 CTP3 instance
