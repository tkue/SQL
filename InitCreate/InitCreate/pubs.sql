...
EXECUTE (N'CREATE DATABASE pubs
  ON PRIMARY (NAME = N''pubs'', FILENAME = N''' + @device_directory + N'pubs.mdf'')
  LOG ON (NAME = N''pubs_log'',  FILENAME = N''' + @device_directory + N'pubs.ldf'')')
go
